...
type Order = { id: string; created_at: string; status: OrderStatus; payment_status: string; shipping: number; total: number; tracking_code: string | null; carrier: string | null; invoice_url: string | null; order_items: { product_name: string; quantity: number; unit_price: number; total: number }[]; product_reviews: { id: string }[] }
