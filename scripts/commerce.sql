...
-- Perguntas sobre produtos: o cliente pergunta na página do produto e a loja responde pelo painel.
-- product_id fica como text porque o restante do schema já compara produtos por texto (ver confirm_paid_order).
